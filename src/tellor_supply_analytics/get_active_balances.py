...
class EnhancedActiveBalancesCollector:
    ...
    def get_bridge_balance(self, layer_height: Optional[int] = None) -> Optional[float]:
        """
    ...
    def collect_and_save_balances(self, addresses: List[Tuple[str, str]], block_height: Optional[int] = None):
        ...
        # Get bridge balance (pass layer height to determine correct bridge contract)
        bridge_balance = self.get_bridge_balance(layer_height=block_height)
